...
- **Prometheus UI**:
      ...
      nohup kubectl port-forward service/prometheus-operated -n monitoring 9090:9090 --address 0.0.0.0 > port-forward.log 2>&1 &
...
- **Grafana UI**: password is `prom-operator`
      ...
      nohup kubectl port-forward service/monitoring-grafan -n monitoring 8080:80 --address 0.0.0.0 > grafana.log 2>&1 &

# Note: access http://<ec2 ip>:8080

**Alertmanager UI**:

     nohup kubectl port-forward service/alertmanager-operated -n monitoring 9093:9093 --address 0.0.0.0 > alertmanager.log 2>&1 &
